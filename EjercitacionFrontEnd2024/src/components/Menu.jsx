//Aca se provee la interfaz html para elegir las pantallas que ofrecera nuestra aplicacion.
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
               ...
               {/* navlink es un componente de react que permite crear link de navegacion. Esto permite luego aplicarle estilo CSS*/}

               {/* Este es el enlace para poder acceder a la pagina de Inicio*/}
              <NavLink className="nav-link" to="/inicio">
                Inicio
              </NavLink>
            </li>

            {/* Este es el enlace para poder acceder a la pagina de ArticulosFamilias*/}
            <li className="nav-item">
            ...
            {/* Este es el enlace para poder acceder a la pagina de Articulos*/}
            <li className="nav-item">
            ...
            {/* Este es el enlace para poder acceder a la pagina de Empleados*/}
            <li className="nav-item">
